...
class TestGoofs(LoaderTest):
    def test_parse(self):
        ...
        expected = [
                {
                    u'goofs': [
                        u'MISC: At the end of each episode there is a list of "Cast in order of appearance", but '
                        u'on several occasions, the order of the list does not reflect the actual order in which '
                        u'the actors appear in the episode. In season 5, there are even some episodes where actors '
                        u'are credited in the list without appearing in the episode.',
                        u'FACT: The flag on the helmets of the German soldiers is not a German flag. The German flag '
                        u'is yellow-red-black, while the flag on the helmet is red-yellow-black.'
                        ],
                    u'name': u'"\'Allo \'Allo!" (1982)'
                    },
                {
                    u'goofs': [
                        u'CONT: When Steph and Jeff help Eddie into the kitchen, Steph places a bottle of Coke to the '
                        u'left of Eddie. In the next shot, the bottle is to his right. Then, the bottle proceeds to '
                        u'move from one side of the table to the other in the successive shots.',
                        u'CONT: After Eddie opens the bottle of Coke in the kitchen, it fizzes up and spills. '
                        u'Then after Steph catches him cleaning it up, the bottle goes from having the cap off to '
                        u'having the cap on. Then, once Eddie sits back in the chair, the volume of the bottle '
                        u'fluctuates as does the location of the bottle cap.'
                        ],
